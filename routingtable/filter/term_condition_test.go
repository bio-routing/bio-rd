...
func TestMatches(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(127, 0, 0, 1).Ptr(), 8).Ptr(),
			prefixLists: []*PrefixList{
				NewPrefixList(net.NewPfx(net.IPv4FromOctets(127, 0, 0, 1).Ptr(), 8).Ptr()),
			},
			expected: true,
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(127, 0, 0, 1).Ptr(), 8).Ptr(),
			prefixLists: []*PrefixList{
				NewPrefixList(net.NewPfx(net.IPv4(0).Ptr(), 32).Ptr()),
			},
			expected: false,
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(127, 0, 0, 1).Ptr(), 8).Ptr(),
			prefixLists: []*PrefixList{
				NewPrefixList(net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 8).Ptr()),
				NewPrefixList(net.NewPfx(net.IPv4FromOctets(127, 0, 0, 1).Ptr(), 8).Ptr()),
			},
			expected: true,
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 24).Ptr(),
			routeFilters: []*RouteFilter{
				NewRouteFilter(net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 8).Ptr(), NewLongerMatcher()),
			},
			expected: true,
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 24).Ptr(),
			routeFilters: []*RouteFilter{
				NewRouteFilter(net.NewPfx(net.IPv4FromOctets(8, 0, 0, 0).Ptr(), 8).Ptr(), NewLongerMatcher()),
				NewRouteFilter(net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 8).Ptr(), NewLongerMatcher()),
			},
			expected: true,
		},
		...
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(9, 9, 9, 0).Ptr(), 24).Ptr(),
			prefixLists: []*PrefixList{
				NewPrefixList(net.NewPfx(net.IPv4FromOctets(8, 0, 0, 0).Ptr(), 8).Ptr()),
			},
			routeFilters: []*RouteFilter{
				NewRouteFilter(net.NewPfx(net.IPv4FromOctets(10, 0, 0, 0).Ptr(), 8).Ptr(), NewLongerMatcher()),
			},
		...
		},
		{
			...
			prefix: net.NewPfx(net.IPv4FromOctets(8, 8, 8, 0).Ptr(), 24).Ptr(),
			prefixLists: []*PrefixList{
				NewPrefixList(net.NewPfx(net.IPv4FromOctets(8, 0, 0, 0).Ptr(), 8).Ptr()),
			},
			routeFilters: []*RouteFilter{
