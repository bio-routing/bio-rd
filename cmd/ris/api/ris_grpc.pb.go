...
const (
	...
	RoutingInformationService_GetPrefixFromAllRouters_FullMethodName = "/bio.ris.RoutingInformationService/GetPrefixFromAllRouters"
)
...
type RoutingInformationServiceClient interface {
	...
	GetPrefixFromAllRouters(ctx context.Context, in *GetPrefixFromAllRoutersRequest, opts ...grpc.CallOption) (*GetResponse, error)
}
...
func (c *routingInformationServiceClient) LPM(ctx context.Context, in *LPMRequest, opts ...grpc.CallOption) (*LPMResponse, error) {
	out := new(LPMResponse)
	err := c.cc.Invoke(ctx, RoutingInformationService_LPM_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, RoutingInformationService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) GetRouters(ctx context.Context, in *GetRoutersRequest, opts ...grpc.CallOption) (*GetRoutersResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingInformationService_GetRouters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) GetLonger(ctx context.Context, in *GetLongerRequest, opts ...grpc.CallOption) (*GetLongerResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingInformationService_GetLonger_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) ObserveRIB(ctx context.Context, in *ObserveRIBRequest, opts ...grpc.CallOption) (RoutingInformationService_ObserveRIBClient, error) {
	stream, err := c.cc.NewStream(ctx, &RoutingInformationService_ServiceDesc.Streams[0], RoutingInformationService_ObserveRIB_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routingInformationServiceClient) DumpRIB(ctx context.Context, in *DumpRIBRequest, opts ...grpc.CallOption) (RoutingInformationService_DumpRIBClient, error) {
	stream, err := c.cc.NewStream(ctx, &RoutingInformationService_ServiceDesc.Streams[1], RoutingInformationService_DumpRIB_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routingInformationServiceClient) GetPrefixFromAllRouters(ctx context.Context, in *GetPrefixFromAllRoutersRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, RoutingInformationService_GetPrefixFromAllRouters_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoutingInformationServiceServer interface {
	...
	GetPrefixFromAllRouters(context.Context, *GetPrefixFromAllRoutersRequest) (*GetResponse, error)
...
func (UnimplementedRoutingInformationServiceServer) GetPrefixFromAllRouters(context.Context, *GetPrefixFromAllRoutersRequest) (*GetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPrefixFromAllRouters not implemented")
}
...
func _RoutingInformationService_GetPrefixFromAllRouters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPrefixFromAllRoutersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingInformationServiceServer).GetPrefixFromAllRouters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingInformationService_GetPrefixFromAllRouters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingInformationServiceServer).GetPrefixFromAllRouters(ctx, req.(*GetPrefixFromAllRoutersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoutingInformationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPrefixFromAllRouters",
			Handler:    _RoutingInformationService_GetPrefixFromAllRouters_Handler,
		},
	},
