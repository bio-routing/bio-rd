...
const (
	RoutingInformationService_LPM_FullMethodName        = "/bio.ris.RoutingInformationService/LPM"
	RoutingInformationService_Get_FullMethodName        = "/bio.ris.RoutingInformationService/Get"
	RoutingInformationService_GetRouters_FullMethodName = "/bio.ris.RoutingInformationService/GetRouters"
	RoutingInformationService_GetLonger_FullMethodName  = "/bio.ris.RoutingInformationService/GetLonger"
	RoutingInformationService_ObserveRIB_FullMethodName = "/bio.ris.RoutingInformationService/ObserveRIB"
	RoutingInformationService_DumpRIB_FullMethodName    = "/bio.ris.RoutingInformationService/DumpRIB"
)
...
type RoutingInformationServiceClient interface {
	...
	ObserveRIB(ctx context.Context, in *ObserveRIBRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RIBUpdate], error)
	DumpRIB(ctx context.Context, in *DumpRIBRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DumpRIBReply], error)
}
...
func (c *routingInformationServiceClient) LPM(ctx context.Context, in *LPMRequest, opts ...grpc.CallOption) (*LPMResponse, error) {
	...
	out := new(LPMResponse)
	err := c.cc.Invoke(ctx, RoutingInformationService_LPM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, RoutingInformationService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) GetRouters(ctx context.Context, in *GetRoutersRequest, opts ...grpc.CallOption) (*GetRoutersResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingInformationService_GetRouters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) GetLonger(ctx context.Context, in *GetLongerRequest, opts ...grpc.CallOption) (*GetLongerResponse, error) {
	...
	err := c.cc.Invoke(ctx, RoutingInformationService_GetLonger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routingInformationServiceClient) ObserveRIB(ctx context.Context, in *ObserveRIBRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RIBUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RoutingInformationService_ServiceDesc.Streams[0], RoutingInformationService_ObserveRIB_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ObserveRIBRequest, RIBUpdate]{ClientStream: stream}
...
type RoutingInformationService_ObserveRIBClient = grpc.ServerStreamingClient[RIBUpdate]

func (c *routingInformationServiceClient) DumpRIB(ctx context.Context, in *DumpRIBRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DumpRIBReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RoutingInformationService_ServiceDesc.Streams[1], RoutingInformationService_DumpRIB_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DumpRIBRequest, DumpRIBReply]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RoutingInformationService_DumpRIBClient = grpc.ServerStreamingClient[DumpRIBReply]
...
type RoutingInformationServiceServer interface {
	...
	ObserveRIB(*ObserveRIBRequest, grpc.ServerStreamingServer[RIBUpdate]) error
	DumpRIB(*DumpRIBRequest, grpc.ServerStreamingServer[DumpRIBReply]) error
	mustEmbedUnimplementedRoutingInformationServiceServer()
}

// UnimplementedRoutingInformationServiceServer must be embedded to have
...
func (UnimplementedRoutingInformationServiceServer) ObserveRIB(*ObserveRIBRequest, grpc.ServerStreamingServer[RIBUpdate]) error {
	return status.Errorf(codes.Unimplemented, "method ObserveRIB not implemented")
}
func (UnimplementedRoutingInformationServiceServer) DumpRIB(*DumpRIBRequest, grpc.ServerStreamingServer[DumpRIBReply]) error {
...
func (UnimplementedRoutingInformationServiceServer) testEmbeddedByValue() {}
...
func RegisterRoutingInformationServiceServer(s grpc.ServiceRegistrar, srv RoutingInformationServiceServer) {
	// If the following call pancis, it indicates UnimplementedRoutingInformationServiceServer was
...
func _RoutingInformationService_LPM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingInformationService_LPM_FullMethodName,
	}
...
func _RoutingInformationService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingInformationService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RoutingInformationService_GetRouters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingInformationService_GetRouters_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RoutingInformationService_GetLonger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoutingInformationService_GetLonger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RoutingInformationService_ObserveRIB_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RoutingInformationServiceServer).ObserveRIB(m, &grpc.GenericServerStream[ObserveRIBRequest, RIBUpdate]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RoutingInformationService_ObserveRIBServer = grpc.ServerStreamingServer[RIBUpdate]
...
func _RoutingInformationService_DumpRIB_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RoutingInformationServiceServer).DumpRIB(m, &grpc.GenericServerStream[DumpRIBRequest, DumpRIBReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RoutingInformationService_DumpRIBServer = grpc.ServerStreamingServer[DumpRIBReply]
