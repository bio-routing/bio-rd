...
type ObserveRoutersRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ObserveRoutersRequest) Reset() {
	*x = ObserveRoutersRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObserveRoutersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObserveRoutersRequest) ProtoMessage() {}

func (x *ObserveRoutersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_ris_api_ris_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObserveRoutersRequest.ProtoReflect.Descriptor instead.
func (*ObserveRoutersRequest) Descriptor() ([]byte, []int) {
...
type RouterUpdate struct {
	...
	IsGone        bool    `protobuf:"varint,3,opt,name=is_gone,json=isGone,proto3" json:"is_gone,omitempty"`
	IsInitialDump bool    `protobuf:"varint,4,opt,name=is_initial_dump,json=isInitialDump,proto3" json:"is_initial_dump,omitempty"`
}

func (x *RouterUpdate) Reset() {
	*x = RouterUpdate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmd_ris_api_ris_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RouterUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RouterUpdate) ProtoMessage() {}

func (x *RouterUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_ris_api_ris_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RouterUpdate.ProtoReflect.Descriptor instead.
func (*RouterUpdate) Descriptor() ([]byte, []int) {
	return file_cmd_ris_api_ris_proto_rawDescGZIP(), []int{15}
}

func (x *RouterUpdate) GetAdvertisement() bool {
	if x != nil {
		return x.Advertisement
	}
	return false
...
func (x *RouterUpdate) GetRouter() *Router {
	if x != nil {
		return x.Router
	}
	return nil
...
func (x *RouterUpdate) GetIsGone() bool {
	if x != nil {
		return x.IsGone
	}
	return false
...
func (x *RouterUpdate) GetIsInitialDump() bool {
	if x != nil {
		return x.IsInitialDump
	}
	return false
...
var file_cmd_ris_api_ris_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x2f, 0x63, 0x6d, 0x64, 0x2f, 0x72, 0x69, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70,
...
var file_cmd_ris_api_ris_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_cmd_ris_api_ris_proto_goTypes = []interface{}{
	...
	(*ObserveRoutersRequest)(nil),  // 16: bio.ris.ObserveRoutersRequest
	(*RouterUpdate)(nil),           // 17: bio.ris.RouterUpdate
	(*api.Prefix)(nil),             // 18: bio.net.Prefix
	(*api1.Route)(nil),             // 19: bio.route.Route
}
var file_cmd_ris_api_ris_proto_depIdxs = []int32{
	18, // 0: bio.ris.LPMRequest.pfx:type_name -> bio.net.Prefix
	19, // 1: bio.ris.LPMResponse.routes:type_name -> bio.route.Route
	18, // 2: bio.ris.GetRequest.pfx:type_name -> bio.net.Prefix
	19, // 3: bio.ris.GetResponse.routes:type_name -> bio.route.Route
	18, // 4: bio.ris.GetLongerRequest.pfx:type_name -> bio.net.Prefix
	19, // 5: bio.ris.GetLongerResponse.routes:type_name -> bio.route.Route
	0,  // 6: bio.ris.ObserveRIBRequest.afisafi:type_name -> bio.ris.ObserveRIBRequest.AFISAFI
	19, // 7: bio.ris.RIBUpdate.route:type_name -> bio.route.Route
	...
	19, // 10: bio.ris.DumpRIBReply.route:type_name -> bio.route.Route
	14, // 11: bio.ris.GetRoutersResponse.routers:type_name -> bio.ris.Router
	14, // 12: bio.ris.RouterUpdate.router:type_name -> bio.ris.Router
	...
	13, // 15: bio.ris.RoutingInformationService.GetRouters:input_type -> bio.ris.GetRoutersRequest
	6,  // 16: bio.ris.RoutingInformationService.GetLonger:input_type -> bio.ris.GetLongerRequest
	8,  // 17: bio.ris.RoutingInformationService.ObserveRIB:input_type -> bio.ris.ObserveRIBRequest
	11, // 18: bio.ris.RoutingInformationService.DumpRIB:input_type -> bio.ris.DumpRIBRequest
	16, // 19: bio.ris.RoutingInformationService.ObserveRouters:input_type -> bio.ris.ObserveRoutersRequest
	3,  // 20: bio.ris.RoutingInformationService.LPM:output_type -> bio.ris.LPMResponse
	5,  // 21: bio.ris.RoutingInformationService.Get:output_type -> bio.ris.GetResponse
	15, // 22: bio.ris.RoutingInformationService.GetRouters:output_type -> bio.ris.GetRoutersResponse
	7,  // 23: bio.ris.RoutingInformationService.GetLonger:output_type -> bio.ris.GetLongerResponse
	10, // 24: bio.ris.RoutingInformationService.ObserveRIB:output_type -> bio.ris.RIBUpdate
	12, // 25: bio.ris.RoutingInformationService.DumpRIB:output_type -> bio.ris.DumpRIBReply
	17, // 26: bio.ris.RoutingInformationService.ObserveRouters:output_type -> bio.ris.RouterUpdate
...
func file_cmd_ris_api_ris_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cmd_ris_api_ris_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObserveRoutersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cmd_ris_api_ris_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RouterUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
