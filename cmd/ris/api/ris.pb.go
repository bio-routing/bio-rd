...
type ObserveRIBOptions struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MaxPaths uint32 `protobuf:"varint,1,opt,name=MaxPaths,proto3" json:"MaxPaths,omitempty"` // maximum number of paths to send per route, only used when both EcmpOnly and BestOnly are both false
	EcmpOnly bool   `protobuf:"varint,2,opt,name=EcmpOnly,proto3" json:"EcmpOnly,omitempty"` // should we only send equal cost paths (ignoring MaxPaths) ? Only applies if BestOnly is false.
	BestOnly bool   `protobuf:"varint,3,opt,name=BestOnly,proto3" json:"BestOnly,omitempty"` // should we only send the best path for each route ? Take precedence over EcmpOnly.
}

func (x *ObserveRIBOptions) Reset() {
	*x = ObserveRIBOptions{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObserveRIBOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObserveRIBOptions) ProtoMessage() {}

func (x *ObserveRIBOptions) ProtoReflect() protoreflect.Message {
	mi := &file_cmd_ris_api_ris_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObserveRIBOptions.ProtoReflect.Descriptor instead.
func (*ObserveRIBOptions) Descriptor() ([]byte, []int) {
	return file_cmd_ris_api_ris_proto_rawDescGZIP(), []int{6}
}

func (x *ObserveRIBOptions) GetMaxPaths() uint32 {
	if x != nil {
		return x.MaxPaths
	}
	return 0
...
func (x *ObserveRIBOptions) GetEcmpOnly() bool {
	if x != nil {
		return x.EcmpOnly
	}
	return false
...
func (x *ObserveRIBOptions) GetBestOnly() bool {
	if x != nil {
		return x.BestOnly
	}
	return false
...
type ObserveRIBRequest struct {
	...
	ObserveOptions  *ObserveRIBOptions        `protobuf:"bytes,6,opt,name=observe_options,json=observeOptions,proto3,oneof" json:"observe_options,omitempty"` // additional options for the observe request
}
...
func (x *ObserveRIBRequest) GetObserveOptions() *ObserveRIBOptions {
	if x != nil {
		return x.ObserveOptions
	}
	return nil
}
...
var file_cmd_ris_api_ris_proto_rawDesc = []byte{
	...
	,
	...
	0x2d, 0x72, 0x64, 0x2f, 0x63, 0x6d, 0x64, 0x2f, 0x72, 0x69, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x62,
...
var file_cmd_ris_api_ris_proto_goTypes = []interface{}{
	...
	(*ObserveRIBOptions)(nil),      // 8: bio.ris.ObserveRIBOptions
...
var file_cmd_ris_api_ris_proto_depIdxs = []int32{
	...
	18, // 3: bio.ris.GetResponse.routes:type_name -> bio.route.Route
	17, // 4: bio.ris.GetLongerRequest.pfx:type_name -> bio.net.Prefix
	18, // 5: bio.ris.GetLongerResponse.routes:type_name -> bio.route.Route
	0,  // 6: bio.ris.ObserveRIBRequest.afisafi:type_name -> bio.ris.ObserveRIBRequest.AFISAFI
	8,  // 7: bio.ris.ObserveRIBRequest.observe_options:type_name -> bio.ris.ObserveRIBOptions
	...
	6,  // 16: bio.ris.RoutingInformationService.GetLonger:input_type -> bio.ris.GetLongerRequest
	...
	3,  // 19: bio.ris.RoutingInformationService.LPM:output_type -> bio.ris.LPMResponse
	5,  // 20: bio.ris.RoutingInformationService.Get:output_type -> bio.ris.GetResponse
	16, // 21: bio.ris.RoutingInformationService.GetRouters:output_type -> bio.ris.GetRoutersResponse
	7,  // 22: bio.ris.RoutingInformationService.GetLonger:output_type -> bio.ris.GetLongerResponse
	11, // 23: bio.ris.RoutingInformationService.ObserveRIB:output_type -> bio.ris.RIBUpdate
	13, // 24: bio.ris.RoutingInformationService.DumpRIB:output_type -> bio.ris.DumpRIBReply
...
func file_cmd_ris_api_ris_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cmd_ris_api_ris_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObserveRIBOptions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_cmd_ris_api_ris_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
