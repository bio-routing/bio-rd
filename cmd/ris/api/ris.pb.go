...
var file_cmd_ris_api_ris_proto_rawDesc = string([]byte{
...
var (
	...
	file_cmd_ris_api_ris_proto_rawDescData []byte
)

func file_cmd_ris_api_ris_proto_rawDescGZIP() []byte {
	file_cmd_ris_api_ris_proto_rawDescOnce.Do(func() {
		file_cmd_ris_api_ris_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cmd_ris_api_ris_proto_rawDesc), len(file_cmd_ris_api_ris_proto_rawDesc)))
	})
...
var file_cmd_ris_api_ris_proto_goTypes = []any{
...
func file_cmd_ris_api_ris_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cmd_ris_api_ris_proto_rawDesc), len(file_cmd_ris_api_ris_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
