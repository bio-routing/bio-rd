...
func (x *SignalNotification) Reset() {
	*x = SignalNotification{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SignalNotification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignalNotification) ProtoMessage() {}

func (x *SignalNotification) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignalNotification.ProtoReflect.Descriptor instead.
func (*SignalNotification) Descriptor() ([]byte, []int) {
	return file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_rawDescGZIP(), []int{4}
}

func (x *SignalNotification) GetSignal() int32 {
	if x != nil {
		return x.Signal
	}
	return 0
...
func (x *SignalNotification) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
var file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x61, 0x66, 0x69, 0x22, 0x40, 0x0a, 0x12, 0x53, 0x69, 0x67,
	...
	,
...
var file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_goTypes = []interface{}{
	...
	(*SignalNotification)(nil),   // 4: bio.bgp.SignalNotification
	(*api.IP)(nil),               // 5: bio.net.IP
	(*Session)(nil),              // 6: bio.bgp.Session
	(*api1.Route)(nil),           // 7: bio.route.Route
}
var file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_depIdxs = []int32{
	...
	5, // 1: bio.bgp.SessionFilter.neighbor_ip:type_name -> bio.net.IP
	6, // 2: bio.bgp.ListSessionsResponse.sessions:type_name -> bio.bgp.Session
	5, // 3: bio.bgp.DumpRIBRequest.peer:type_name -> bio.net.IP
	...
	4, // 7: bio.bgp.BgpService.SignalChat:input_type -> bio.bgp.SignalNotification
	2, // 8: bio.bgp.BgpService.ListSessions:output_type -> bio.bgp.ListSessionsResponse
	7, // 9: bio.bgp.BgpService.DumpRIBIn:output_type -> bio.route.Route
	7, // 10: bio.bgp.BgpService.DumpRIBOut:output_type -> bio.route.Route
	4, // 11: bio.bgp.BgpService.SignalChat:output_type -> bio.bgp.SignalNotification
...
func file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_bio_routing_bio_rd_protocols_bgp_api_bgp_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignalNotification); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type BgpServiceClient interface {
	...
	SignalChat(ctx context.Context, opts ...grpc.CallOption) (BgpService_SignalChatClient, error)
}
...
func (c *bgpServiceClient) SignalChat(ctx context.Context, opts ...grpc.CallOption) (BgpService_SignalChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BgpService_serviceDesc.Streams[2], "/bio.bgp.BgpService/SignalChat", opts...)
	if err != nil {
		return nil, err
	}
	x := &bgpServiceSignalChatClient{stream}
	return x, nil
}

type BgpService_SignalChatClient interface {
	Send(*SignalNotification) error
	Recv() (*SignalNotification, error)
	grpc.ClientStream
}

type bgpServiceSignalChatClient struct {
	grpc.ClientStream
}

func (x *bgpServiceSignalChatClient) Send(m *SignalNotification) error {
	return x.ClientStream.SendMsg(m)
}

func (x *bgpServiceSignalChatClient) Recv() (*SignalNotification, error) {
	m := new(SignalNotification)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type BgpServiceServer interface {
	...
	SignalChat(BgpService_SignalChatServer) error
}
...
func (*UnimplementedBgpServiceServer) SignalChat(BgpService_SignalChatServer) error {
	return status.Errorf(codes.Unimplemented, "method SignalChat not implemented")
}
...
func _BgpService_SignalChat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BgpServiceServer).SignalChat(&bgpServiceSignalChatServer{stream})
}

type BgpService_SignalChatServer interface {
	Send(*SignalNotification) error
	Recv() (*SignalNotification, error)
	grpc.ServerStream
}

type bgpServiceSignalChatServer struct {
	grpc.ServerStream
}

func (x *bgpServiceSignalChatServer) Send(m *SignalNotification) error {
	return x.ServerStream.SendMsg(m)
}

func (x *bgpServiceSignalChatServer) Recv() (*SignalNotification, error) {
	m := new(SignalNotification)
...
var _BgpService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SignalChat",
			Handler:       _BgpService_SignalChat_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
